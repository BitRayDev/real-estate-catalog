  ...
  <ObjectProfile :object="object" :properties="properties" @property-edited="onPropertyEdited">
    <template #buttons>
      <div class="flex flex-col">
        <AppButton class="mt-2 px-8 !py-2 bg-red-400 text-white font-medium border-none"
                   @click.native="deleteClick">Удалить обяъвление
        </AppButton>
        <NuxtLink :to="`/cabinet/objects/${route.params.objectId}/edit-booking`">
          <AppButton class="mt-2 px-8 !py-2 bg-green-400 text-white font-medium border-none">
            Редактировать календарь бронрования
          </AppButton>
        </NuxtLink>
        <NuxtLink :to="`/cabinet/objects/${route.params.objectId}/edit-photos`">
          <AppButton class="w-full mt-2 px-8 !py-2 bg-green-400 text-white font-medium border-none">
            Редактировать фото
          </AppButton>
        </NuxtLink>
      </div>
